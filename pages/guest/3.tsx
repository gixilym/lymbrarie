...
function GuestPage3(): Component {
  const { openPopUp } = usePopUp(),
    [t] = useTranslation("global"),
    [animations] = useLocalStorage("animations", true),
    Cover: AnimatedComponent<typeof Image> = animated(Image),
    [notes, setNotes] = useState<string>(t("notes-book-3")),
    notesProps = {
      notes,
      setNotes,
      isLoading: false,
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3 text-slate-300">
              <div className="flex items-center gap-x-3">
                ...
                <p className="text-base sm:text-lg">J. K. Rowling</p>
              </div>
              ...
              <div className="flex items-center gap-x-3">
                ...
                <p className="text-base sm:text-lg">{t("new-book-read")}</p>
              </div>
            </div>
