...
export default BookRecommendationId;

// function BookRecommendationId(): Component {
//   const auth: Auth = getAuth(),
//     { openPopUp, closeBookPopUps } = usePopUp(),
//     [t] = useTranslation("global"),
...
//   useEffect(() => {
//     if (!recommendations) router.push(PAGES.HOME);
...
//         <AddToLibraryPopUp title={BOOK_RECO.title ?? ""} documentId="lol" />
//       )}
...
//           src={BOOK_RECO.image || defaultCover}
//           width={200}
//           height={300}
//           alt="cover"
//         />
...
//               className="btn btn-square bg-slate-700/30 sm:bg-slate-700/25 hover:bg-slate-700/50 border-2 border-slate-700/40 mt-4 sm:mt-0 mb-1"
//             >
//               <PlusIcon className="w-6 h-6 sm:w-7 sm:h-8" />
//             </button>
//             <ShareBtn title={BOOK_RECO.title ?? ""} />
//           </animated.div>
//         </div>
//       </article>
//     </animated.section>
