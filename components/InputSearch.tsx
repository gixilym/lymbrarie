...
function InputSearch({ query, setQuery }: Props) {
  ...
  return (
    <div className="join w-full max-w-lg">
      ...
      <button
        type="submit"
        className="join-item btn h-14 px-8 bg-violet-500/50 hover:bg-violet-500/60 border-2 border-violet-500/20 hover:border-violet-500/40 backdrop-blur-sm rounded-r-xl border-l-0 transition-all"
      >
