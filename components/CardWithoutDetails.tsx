  ...
  return (
    ...
    >
      <div className="flex justify-start items-center gap-x-4 w-full">
        ...
        <p
          title={title}
          className="sm:w-full w-[200px]  text-xl font-ligth overflow-ellipsis overflow-hidden whitespace-nowrap bg-gradient-to-r from-[#cdc7ff] via-[#8678f9] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-transparent"
        >
          {title}
        </p>
        {state && formatState()}
